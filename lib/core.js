...
- メモに大学名・会社名・勤務先名などの固有名詞が含まれていても、具体的な名称はそのまま出力に含めないこと。個人情報保護のため名称は伏せるが、誰もが知る難関大学・有名企業・大手企業などアピールポイントになりうる場合は、その「格」が伝わる言い換えをすること（例:早稲田・慶應等→「難関私立大学」、東京大学等→「難関国公立大学」、楽天・ソニー等→「誰もが知る大手企業」）。特に有名でない場合は「大学」「会社員」「病院」のような一般的な表現でよい。職業の種類・業界を一般的なレベルで伝えるのは問題ない。${concernsInstruction}${disabledInstruction}${customHeadingsBlock}
