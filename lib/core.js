...
- メモに大学名・会社名・勤務先名などの固有名詞が含まれていても、それらをそのまま出力に含めないこと。個人情報保護のため、一般的な表現に言い換えること（例:「◯◯大学」→「大学」、「株式会社◯◯」→「会社員」、「◯◯病院」→「病院」）。職業の種類・業界を一般的なレベルで伝えるのは問題ない。${concernsInstruction}${disabledInstruction}${customHeadingsBlock}
